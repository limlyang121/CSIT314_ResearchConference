...
<html>
<head>
<script language = "javascript" type = "text/javascript" src ="<%=request.getContextPath() %>/script.js"> </script>
...
<h1>
	...
	<form  action = "logout" onsubmit = "return logout2();" >
		<button type = "submit"> Button </button>
	</form>
	
	<button onclick = "logout2()">AAAA</button>
